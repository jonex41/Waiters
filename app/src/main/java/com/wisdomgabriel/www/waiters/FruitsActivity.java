...
public class FruitsActivity extends AppCompatActivity {
    ...
    private void setUpAdapter() {
        ...
        Query query = FirebaseFirestore.getInstance().collection("fruits");
                        ...
                        FirebaseFirestore.getInstance().collection("orders").document(id2).delete().addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if(task.isSuccessful()){
                                    Toast.makeText(FruitsActivity.this, "Pdf has been deleted", Toast.LENGTH_SHORT).show();
                                }else {

                                    Toast.makeText(FruitsActivity.this, "Please try again later", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
