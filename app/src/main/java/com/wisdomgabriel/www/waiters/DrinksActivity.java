...
public class DrinksActivity extends AppCompatActivity {
    ...
    private void setUpAdapter() {
        ...
        Query query = FirebaseFirestore.getInstance().collection("drinks");
                        ...
                        FirebaseFirestore.getInstance().collection("orders").document(id2).delete().addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if(task.isSuccessful()){
                                    Toast.makeText(DrinksActivity.this, "Pdf has been deleted", Toast.LENGTH_SHORT).show();
                                }else {

                                    Toast.makeText(DrinksActivity.this, "Please try again later", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
    ...
    class ShopViewHolder extends RecyclerView.ViewHolder {
        ...
        public ShopViewHolder(View itemView) {
         ...
         //   sit = (TextView) mView.findViewById(R.id.sit);
           // platenumber = (TextView) mView.findViewById(R.id.foodplatenumber);
       ...
       /* public void setSit(String sitnumber) {
            sit.setText(sitnumber);
        }

        public void setPlateNumber(String platesNumber) {
            platenumber.setText(platesNumber);
        }*/
    }
}
