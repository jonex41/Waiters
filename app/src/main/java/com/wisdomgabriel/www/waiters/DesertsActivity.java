...
public class DesertsActivity  extends AppCompatActivity{
    ...
    private void setUpAdapter() {
        ...
        Query query = FirebaseFirestore.getInstance().collection("deserts");
                        ...
                        FirebaseFirestore.getInstance().collection("orders").document(id2).delete().addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if(task.isSuccessful()){
                                    Toast.makeText(DesertsActivity.this, "Pdf has been deleted", Toast.LENGTH_SHORT).show();
                                }else {

                                    Toast.makeText(DesertsActivity.this, "Please try again later", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
